...
class MomentsControllerTest < ActionController::TestCase
  ...
  test "should create moment" do
    assert_difference('Moment.count') do
      post :create, moment: { address_id: @moment.address_id, message_id: @moment.message_id, user_id: @moment.user_id }
    end
  ...
  test "should update moment" do
    patch :update, id: @moment, moment: { address_id: @moment.address_id, message_id: @moment.message_id, user_id: @moment.user_id }
    assert_redirected_to moment_path(assigns(:moment))
  end
